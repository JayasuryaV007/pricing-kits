  ...
  <SelectPrimitive.Trigger
    ...
    className={cn(
      'flex h-10 w-full space-x-2 items-center justify-between rounded-md' +
        ...
        ' ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-0 focus:ring-primary disabled:cursor-not-allowed disabled:opacity-50',
      className,
    )}
    {...props}
  >
