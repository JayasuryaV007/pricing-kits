    ...
    <div
      ...
      className={classNames(
        `
         ...
         p-6 lg:w-4/12 xl:p-8 2xl:w-3/12 xl:max-w-xs hover:border-primary dark:hover:border-primary dark:hover:border-2 hover:border-2
      `,
        {
          ...
          <If condition={props.product.badge}>
            <div
              className={classNames(
                ...
                {
                  ['text-primary-foreground bg-secondary']: recommended,
...
function DefaultCheckoutButton(
  ...
  return (
    <div className={'bottom-0 left-0 w-full p-0'}>
      <Button
        block
        className={`${props.hovered && 'dark:bg-white dark:text-gray-900'}`}
        // href={linkHref}
        variant={props.hovered ? 'default' : 'outline'}
        // variant="custom"
      >
